...
- Version aligned to 1.6.15 for the unified release. Documentation fixes (real profile-directory names in examples) and internal CI/lint hardening; no functional changes.
